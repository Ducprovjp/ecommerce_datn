const styles = {
  ...
  button:
    "min-w-[150px] w-full max-w-[200px] bg-black h-[50px] my-3 flex items-center justify-center rounded-xl cursor-pointer text-white font-semibold hover:bg-gray-800 hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-200",
  cart_button:
    "min-w-[120px] max-w-[200px] px-[20px] h-[38px] rounded-[20px] bg-[#f63b60] flex items-center justify-center cursor-pointer hover:bg-[#e12c4f] hover:shadow-lg hover:scale-105 active:scale-95 transition-all duration-200",
  cart_button_text:
    "text-[#fff] text-[16px] font-[600] hover:text-gray-200 transition-all duration-200",
