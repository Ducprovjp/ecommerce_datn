...
const Cart = ({ setOpenCart }) => {
  ...
  const handleClose = () => {
    ...
    setTimeout(() => {
      setOpenCart(false); // Sau khi animation kết thúc, đóng component
              ...
              <Link to="/checkout">
                ...
                >
                  <h1 className="text-[#fff] text-[18px] font-[600]">
                    Checkout Now ({totalPrice.toLocaleString("vi-VN") + " VNĐ"})
                  </h1>
                </div>
              </Link>
            </div>
        ...
        <div className="w-full flex items-center">
          ...
          <div className="pl-[15px] flex-1">
            ...
            <h4 className="font-[400] text-[15px] text-[#00000082]">
              {data.discountPrice.toLocaleString("vi-VN") + " VNĐ"} * {value}
            </h4>
